          ...
          <div className="absolute bottom-4 inset-x-0 px-5">
            <div className="flex flex-wrap items-center relative z-20">
              <div className="flex-col">
                <p className="font-light tracking-wider text-2xl hover:translate-x-3 transition duration-200">
                  Hi There!
                </p>
                <h2 className="flex gap-3 items-center font-semibold text-6xl">
                  I'm{" "}
                  <p
                ...
                <p className="md:max-w-xl text-sm font-medium">{description}</p>
            ...
            <div className="bg-gradient-to-b from-0% to-gray-900 h-10"></div>
          </div>
        </div>
      </div>
    </div>
